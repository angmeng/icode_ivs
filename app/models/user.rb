class User < ActiveRecord::Base
  ...
  has_many :issued_purchase_requisitions, :class_name => "PurchaseRequisition", :foreign_key => "issued_user_id"
  has_many :approved_purchase_requisitions, :class_name => "PurchaseRequisition", :foreign_key => "approved_user_id"
  has_many :approved_purchase_orders, :class_name => "PurchaseOrder", :foreign_key => "approved_user_id"
  has_many :purchased_purchase_orders, :class_name => "PurchaseOrder", :foreign_key => "purchased_user_id"

  attr_accessor :password
  before_save :prepare_password
  
  validates_presence_of :username, :department_id, :employee_number
